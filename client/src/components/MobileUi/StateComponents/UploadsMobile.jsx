...
import VideoPlayer from "../../LaptopUi/videoPlayer";
import { formatDistanceToNow } from "date-fns";
import Loading from "../../Loading";
import SpecificVideoMobile from "./Video/SpecificVideoMobile";
import { CommentSection } from "../../LaptopUi/StateComponents/Comments/CommentSection";

function UploadsMobile({ type, email, firstName, currentUser }) {
    ...
    if (loading) {
      ...
      return (
        <Box className="h-full w-full  flex flex-col justify-center items-center">
          <Box className="xs:w-6/12 h-3/6   my-5">
            <SpecificVideoMobile
          ...
          <Box className="w-full h-3/6 overflow-scroll">
            <Box className="query-header w-full ">
            ...
            <Box className="query-value w-full p-2 flex flex-col justify-center items-center my-3 ">
              <input
                type="text"
                value={query}
            ...
            <Box className="query-list overflow-auto">
              <CommentSection
